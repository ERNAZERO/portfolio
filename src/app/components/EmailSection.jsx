    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/ERNAZERO/JudoDojo">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/ernaz-erkinbekov/">
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-blue-400 hover:bg-blue-900 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
